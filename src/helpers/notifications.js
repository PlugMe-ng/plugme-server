...
export const eventDescriptions = {
  ...
  [events.OPPORTUNITY_APPLICATION]: 'has plugged to a job you uploaded',
  [events.OPPORTUNITY_ACHIEVER_SET]: 'has plugged you to an job',
  [events.OPPORTUNITY_ACHIEVER_SET_OTHERS]: 'You were not plugged to this job',
  [events.OPPORTUNITY_REVIEW]: 'has reviewed your job',
  [events.NEW_FAN]: 'is now a fan of yours',
  [events.NEW_CONTENT]: 'has published a new content',
  [events.NEW_OPPORTUNITY]: 'has uploaded a new job',
  [events.CONTENT_DELETE]: 'Content deleted by admin',
  [events.OPPORTUNITY_DELETE]: 'Job deleted by admin',
